...
const INPUT_FILE: &str = "jclark_valid_sa_013.xml";

#[test]
/// A valid XML file from the W3C conformance test suite: valid-sa-013
fn valid_sa_013_parse() {
...
"<!DOCTYPE doc [\r\n<!ELEMENT doc (#PCDATA)>\r\n<!ATTLIST doc _.-0123456789 CDATA #IMPLIED>\r\n]>"
    ...
    root.set_name(r#"doc"#);
    root.add_attribute(r#"_.-0123456789"#, r#"v1"#);
    doc
}
